...
- Name: search.spec.ts >> Search Page >> displays breadcrumb navigation
- Location: e2e/search.spec.ts:59:7
...
Locator: getByLabel('Breadcrumb').getByText('Search')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByLabel('Breadcrumb').getByText('Search')
