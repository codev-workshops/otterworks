...
- Name: search.spec.ts >> Search Page >> shows empty state before searching
- Location: e2e/search.spec.ts:21:7
...
Locator: getByText('Search OtterWorks')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Search OtterWorks')
